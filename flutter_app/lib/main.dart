...
class _ZKWalletAppState extends State<ZKWalletApp> {
  ...
  late final GoRouter _router = GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/',
        builder: (context, state) => DashboardScreen(apiService: apiService),
      ),
      GoRoute(
        path: '/send',
        builder: (context, state) => SendScreen(apiService: apiService),
      ),
      GoRoute(
        path: '/history',
      ...
      GoRoute(
        path: '/batches',
        builder: (context, state) => BatchesScreen(apiService: apiService),
      ),
    ],
  );
...
// A simple reusable navigation bar for all screens
    ...
    return AppBar(
      ...
      actions: [
        ...
        TextButton(
          ...
          child: const Text('Batches', style: TextStyle(color: Colors.white)),
        ),
      ],
